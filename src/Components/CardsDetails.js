          ...
          <div className="iteamsdetails">
          {
            ...
            <div className="details">
              <Table>
                <tr>
                  <td>
                    <p> <strong>Restaurant</strong>  : {ele.productname}</p>
                    <p> <strong>Price</strong>  : ₹{ele.productprice}</p>
                    <p> <strong>Dishes</strong>  : {ele.productdecription}</p>
                    <p> <strong>Total</strong>  :₹  {ele.productprice * ele. quantity}</p>
